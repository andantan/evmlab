...
// @Summary      Build, sign, and send legacy contract call tx
// @Description  Fetches chain state, estimates gas, signs with the configured key, broadcasts, and returns unsigned_rlp, signed_rlp, tx_hash, r, s, v
// @Tags         transaction
// @Accept       json
// @Produce      json
...
// @Failure      400   {object}  map[string]string
// @Failure      502   {object}  map[string]string
// @Router       /evm/v4/transaction/contract/legacy [post]
...
// @Summary      Build, sign, and send EIP-1559 contract call tx
// @Description  Fetches chain state, estimates gas, signs with the configured key, broadcasts, and returns unsigned_rlp, signed_rlp, tx_hash, r, s, v
// @Tags         transaction
// @Accept       json
// @Produce      json
...
// @Failure      400   {object}  map[string]string
// @Failure      502   {object}  map[string]string
// @Router       /evm/v4/transaction/contract/eip1559 [post]
